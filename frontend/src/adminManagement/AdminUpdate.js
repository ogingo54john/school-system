...
class AdminUpdate extends Component {
  ...
  componentDidMount() {
    axios
      .get("http://localhost:process.env.PORT/api/admin/edit/" + this.props.match.params.id)
      .then(response => {
        this.setState({
  ...
  handleSubmit = e => {
    ...
    axios
      .post(
        "http://localhost:process.env.PORT/api/admin/update/" + this.props.match.params.id,
        obj
      )
